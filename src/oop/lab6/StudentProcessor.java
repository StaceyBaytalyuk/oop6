...
public class StudentProcessor {
    ...
    private int size = 0; //текущее кол-во записей
    ...
    public void readTextFile(String fileName) { //TODO проверить
    ...
    private Student[] createArray() {
        Student.StudentBuilder builder = new Student.StudentBuilder();
        return new Student[] {
                builder.setID(1).setFullName("Petriv Petr Petrovich").setBirthday("01.02.1998").setFaculty("Computer Science").setAddress("Stroiteley 45").setPhone("3456754").setCourse(3).setGroup(3141).build(),
